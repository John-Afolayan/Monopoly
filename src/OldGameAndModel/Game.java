...
public class Game {
    ...
    //private OldGameAndModel.ModelUpdateListener viewer;
    ...
    */
    ...
    /*
    public void setViewer(OldGameAndModel.ModelUpdateListener viewer) {
        this.viewer = viewer;
    }
    */
    ...
    private void printListOfCurrentPlayerStats() {
        System.out.println("OldGameAndModel.Player " + (currentPlayerInt + 1) + " currently owns the following properties: ");
