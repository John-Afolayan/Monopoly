...
import OldGameAndModel.CircleButton;
import OldGameAndModel.Game;
import OldGameAndModel.ModelUpdateListener;
...
public class View extends JFrame implements ModelUpdateListener {
    ...
    public void Initialize() {
        //Initialize the OldGameAndModel.View
        ...
        //monopolyBoard monopolyBoard = new OldGameAndModel.View.OldGameAndModel.View.monopolyBoard();
        ...
        feedbackArea = new JTextArea("Welcome to Monopoly! Please press New OldGameAndModel.Game in order to start!\n");
